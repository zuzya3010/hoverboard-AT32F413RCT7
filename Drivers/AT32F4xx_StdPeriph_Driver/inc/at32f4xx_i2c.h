...
/**
  ...
  *     event is set.
  *
  *  2) In case of Master Transmitter (7-bit addressing): the I2C_EVENT_MASTER_ADDRESS_WITH_TRANSMITTER
  *     is set
  *
...
/* --EV6 */
#define  I2C_EVENT_MASTER_ADDRESS_WITH_TRANSMITTER      ((uint32_t)0x00070082)  /* BUSY, MSL, ADDR, TXE and TRA flags */
...
#define IS_I2C_EVENT(EVENT)     (((EVENT) == I2C_EVENT_SLAVE_ADDRESS_TRANSMITTER_MATCHED)           || \
                                 ...
                                 ((EVENT) == I2C_EVENT_MASTER_ADDRESS_WITH_TRANSMITTER)             || \
