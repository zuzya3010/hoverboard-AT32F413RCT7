...
#define GPIO_Remap_PTD01            ((uint32_t)0x00008000)  /*!< PD01 Alternate Function mapping */
...
#define IS_GPIO_REMAP(REMAP)        (((REMAP) == GPIO_Remap01_SPI1)         || ((REMAP) == GPIO_Remap_I2C1)           || \
                                     ...
                                     ((REMAP) == GPIO_Remap_PTD01)          || ((REMAP) == GPIO_Remap_TMR5CH4_LSI)    || \
                                     ...
                                     ((REMAP) == GPIO_Remap_SWJ_AllDisable) || ((REMAP) == GPIO_Remap_TMR15)          ||\
                                     ((REMAP) == GPIO_Remap_TMR9)           || ((REMAP) == GPIO_Remap_TMR10)          ||\
                                     ((REMAP) == GPIO_Remap_TMR11)          || ((REMAP) == GPIO_Remap_TMR13)          ||\
                                     ((REMAP) == GPIO_Remap_TMR14)          ||((REMAP) == GPIO_Remap_XMC_NADV)        ||\
                                     ((REMAP) == GPIO_Remap_SPI4)           || ((REMAP) == GPIO_Remap_I2C3)           ||\
                                     ((REMAP) == GPIO_Remap01_SDIO2)        || ((REMAP) == GPIO_Remap10_SDIO2)        ||\
                                     ((REMAP) == GPIO_Remap11_SDIO2)        || ((REMAP) == GPIO_Remap_EXT_FLASH)      ||\
                                     ((REMAP) == GPIO_Remap10_SPI1))
