...
/**
  ...
  * @retval None.
  */
void CAN_FilterInit(CAN_FilterInitType* CAN_FilterInitStruct)
{
  ...
  if (CAN_FilterInitStruct->CAN_FilterScale == CAN_FilterScale_16bit)
  {
    ...
    CAN1->FilterRegister[CAN_FilterInitStruct->CAN_FilterNumber].FBR1 =
      ((0x0000FFFF & (uint32_t)CAN_FilterInitStruct->CAN_FilterMskIdLow) << 16) |
      (0x0000FFFF & (uint32_t)CAN_FilterInitStruct->CAN_FilterIdLow);

    /* Second 16-bit identifier and Second 16-bit mask */
    /* Or Third 16-bit identifier and Fourth 16-bit identifier */
    CAN1->FilterRegister[CAN_FilterInitStruct->CAN_FilterNumber].FBR2 =
