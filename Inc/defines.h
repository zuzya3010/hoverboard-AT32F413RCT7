...
#define LEFT_HALL_U_PIN GPIO_Pins_5
#define LEFT_HALL_V_PIN GPIO_Pins_6
#define LEFT_HALL_W_PIN GPIO_Pins_7

#define LEFT_HALL_U_PORT GPIOB
#define LEFT_HALL_V_PORT GPIOB
#define LEFT_HALL_W_PORT GPIOB

#define RIGHT_HALL_U_PIN GPIO_Pins_10
#define RIGHT_HALL_V_PIN GPIO_Pins_11
#define RIGHT_HALL_W_PIN GPIO_Pins_12

#define RIGHT_HALL_U_PORT GPIOC
#define RIGHT_HALL_V_PORT GPIOC
#define RIGHT_HALL_W_PORT GPIOC

#define LEFT_TIM TMR8
#define LEFT_TIM_U CC1
#define LEFT_TIM_UH_PIN GPIO_Pins_6
#define LEFT_TIM_UH_PORT GPIOC
#define LEFT_TIM_UL_PIN GPIO_Pins_7
#define LEFT_TIM_UL_PORT GPIOA
#define LEFT_TIM_V CC2
#define LEFT_TIM_VH_PIN GPIO_Pins_7
#define LEFT_TIM_VH_PORT GPIOC
#define LEFT_TIM_VL_PIN GPIO_Pins_0
#define LEFT_TIM_VL_PORT GPIOB
#define LEFT_TIM_W CC3
#define LEFT_TIM_WH_PIN GPIO_Pins_8
#define LEFT_TIM_WH_PORT GPIOC
#define LEFT_TIM_WL_PIN GPIO_Pins_1
#define LEFT_TIM_WL_PORT GPIOB

#define RIGHT_TIM TMR1
#define RIGHT_TIM_U CC1
#define RIGHT_TIM_UH_PIN GPIO_Pins_8
#define RIGHT_TIM_UH_PORT GPIOA
#define RIGHT_TIM_UL_PIN GPIO_Pins_13
#define RIGHT_TIM_UL_PORT GPIOB
#define RIGHT_TIM_V CC2
#define RIGHT_TIM_VH_PIN GPIO_Pins_9
#define RIGHT_TIM_VH_PORT GPIOA
#define RIGHT_TIM_VL_PIN GPIO_Pins_14
#define RIGHT_TIM_VL_PORT GPIOB
#define RIGHT_TIM_W CC3
#define RIGHT_TIM_WH_PIN GPIO_Pins_10
#define RIGHT_TIM_WH_PORT GPIOA
#define RIGHT_TIM_WL_PIN GPIO_Pins_15
...
#define LEFT_DC_CUR_PIN GPIO_Pins_0	//These don't exist on the V4 board
#define LEFT_U_CUR_PIN GPIO_Pins_0
#define LEFT_V_CUR_PIN GPIO_Pins_3
...
#define RIGHT_DC_CUR_PIN GPIO_Pins_1
#define RIGHT_U_CUR_PIN GPIO_Pins_4
#define RIGHT_V_CUR_PIN GPIO_Pins_5
...
#define SWITCH_PIN GPIO_Pins_1
#define SWITCH_PORT GPIOA

#define OFF_PIN GPIO_Pins_5
